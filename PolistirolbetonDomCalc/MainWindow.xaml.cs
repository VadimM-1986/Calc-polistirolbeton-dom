...
{
     public readonly CalculatorService calculatorService = new CalculatorService(new PriceRepository(new AppContext()));
    ...
    public void enterploshad_TextChanged(object sender, TextChangedEventArgs e)
    {
        ...
        areaHouseSquarMeters = textBox.Text == "" ? 0 : Convert.ToInt32(textBox.Text);
    }
    ...
    public async void checkBox_walls_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (check == true)
        {
            filedWallsRes = await calculatorService.GetWallsCost(areaHouseSquarMeters);
        }
        else
        {
            filedWallsRes = 0;
    ...
    public async void checkBox_project_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (check == true)
        {
            filedProjectsRes = await calculatorService.GetProjectsCost(areaHouseSquarMeters);
        }
        else
        {
            filedProjectsRes = 0;
    ...
    public async void checkBox_geology_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (check == true)
        {
            filedGeologyRes = await calculatorService.GetGeologyCost();
        }
        else
        {
            filedGeologyRes = 0;
    ...
    public async void checkBox_geodesy_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (check == true)
        {
            filedGeodesyRes = await calculatorService.GetGeodesyCost();
        }
        else
        {
            filedGeodesyRes = 0;
    ...
    public async void checkBox_construction_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (check == true)
        {
            filedConstructionRes = await calculatorService.GetConstructionCost(areaHouseSquarMeters);
        }
        else
        {
            filedConstructionRes = 0;
    ...
    public async void checkBox_armo_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (check == true)
        {
            filedArmoRes = await calculatorService.GetArmoCost(areaHouseSquarMeters);
        }
        else
        {
            filedArmoRes = 0;
    ...
    public async void checkBox_seams_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (check == true)
        {
            filedSeamsRes = await calculatorService.GetSeamsCost(areaHouseSquarMeters);
        }
        else
        {
            filedSeamsRes = 0;
    ...
    {
        TextBox textBox = (TextBox)sender;
        distanceKilometers = textBox.Text == "" ? 0 : Convert.ToInt32(textBox.Text);
    }
    ...
    public async void checkBox_delivery_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (check == true)
        {
            filedDeliveryRes = await calculatorService.GetDeliveryCost(distanceKilometers);
    ...
    public async void checkBox_fundation_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (check == true)
        {
            filedFundationRes = await calculatorService.GetFundationCost(areaHouseSquarMeters);
        }
        else
        {
            filedFundationRes = 0;
    ...
    public async void checkBox_roof_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (check == true)
        {
            filedRoofRes = await calculatorService.GetRoofCost(areaHouseSquarMeters);
        }
        else
        {
            filedRoofRes = 0;
    ...
    public async void checkBox_windows_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (check == true)
        {
            filedWindowsRes = await calculatorService.GetWindowsCost(filedWindowArea);
    ...
    public async void checkBox_door_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (check == true)
        {
            filedDoorRes = await calculatorService.GetDoorCost();
        }
        else
        {
            filedDoorRes = 0;
